...
export async function editor(path, contents) {
    ...
    const fileButton = UI.button('File', buttonContainer, 'md-text-button', 'titlebar-button');
    setupmousedown(fileButton, 'File', menu.file);

    const editButton = UI.button('Edit', buttonContainer, 'md-text-button', 'titlebar-button');
    setupmousedown(editButton, 'Edit', menu.edit);

    const selectionButton = UI.button('Selection', buttonContainer, 'md-text-button', 'titlebar-button');
